<?php
    ...
    if (isset($_POST["submit"])) {
        ...
        if (in_array($_FILES["file"]["type"], $allowedFileType)) {
            ...
            $file_name = 'PFL_Printing_Speed_' . $_SERVER['REMOTE_ADDR'] . '_' . $Updated_By . '_' . date('Y-m-d_H-i-s') . '.xlsx';
            ...
            // check col name exist
                $createArray = array(  'Item_Code', 'Printing_Speed' );
                $makeArray = array( 'Item_Code' => 'Item_Code', 'Printing_Speed' => 'Printing_Speed' );
                $SheetDataKey = array();
                ...
                // Xử lý update code vật tư mới
                    ...
                    if (!$query ) {
                        ...
                        if (mysqli_num_rows($query) > 0 ) {
                            ...
                            $message = "Item Code does not exist in the Master Data ";
                        }
